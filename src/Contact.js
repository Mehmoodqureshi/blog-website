...
const Contact = () => {
  ...
  return (
    ...
    <div className="max-w-[85rem] mt-32">
    <div className="max-w-xl mx-auto">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-black">
          Contact us
        </h1>
      ...
      <div className="mt-8 max-w-lg mx-auto">
        <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 dark:border-gray-700">
          <h2 className="mb-8 text-xl font-semibold text-gray-800 dark:text-gray-800">
            Fill in the form
          </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                  <label
                    ...
                    className="block mb-2 text-sm text-gray-700 font-medium dark:text-gray-800"
                  >
                    First Name
                  </label>
                  <input
      ...
      <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 lg:gap-8">
        <a
        ...
        >
          <svg
            className="size-9 text-gray-800 mx-auto dark:text-gray-700"
        ...
        >
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 text-gray-500">
              Search FAQ for answers to anything you might ask.
            </p>
            <p className="mt-5 inline-flex items-center gap-x-1 font-medium text-blue-600 dark:text-blue-500">
              Visit FAQ
              <svg
